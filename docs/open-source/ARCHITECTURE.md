...
OrdinConn V0.1 is an AI Financial Intelligence and Execution Agent. Its runtime boundaries are model-agnostic, but the current product is not a general-purpose computer-control platform.
