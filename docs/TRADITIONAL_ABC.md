# Traditional Finance ABC

## A — Trading

Deterministic strategies cover price/volume expansion, volatility expansion, breadth plus relative strength, and macro rate repricing. A trigger requires all configured metrics; one attractive value cannot compensate for a missing input.
...
`0.22 order + 0.18 backlog + 0.18 utilization + 0.14 lead-time + 0.16 capex - 0.12 inventory`
